...
const CELEB_CHIPS = [
  { id: "buffett",  initials: "WB", avBg: "#2D5A2D", name: "Warren Buffett",  tag: "Value · Long-term Compounding",   price: "₦3,000/mo · 6.2k users", featured: true  },
  { id: "kiyosaki", initials: "RK", avBg: "#701010", name: "Robert Kiyosaki", tag: "Assets vs Liabilities · Rich Dad", price: "₦2,000/mo · 11.4k users", featured: false },
  { id: "cardone",  initials: "GC", avBg: "#3A1060", name: "Grant Cardone",   tag: "10X Rule · Sales & Income",        price: "₦2,500/mo · 9.1k users",  featured: false },
  { id: "ramsey",   initials: "DR", avBg: "#004070", name: "Dave Ramsey",     tag: "Debt Freedom · Baby Steps",        price: "₦1,500/mo · 5.3k users",  featured: false },
  { id: "lynch",    initials: "PL", avBg: "#1A3A5E", name: "Peter Lynch",     tag: "Stock Picking · Ten-Baggers",      price: "₦2,000/mo · 3.8k users",  featured: false },
  { id: "trump",    initials: "DT", avBg: "#5A3800", name: "Donald Trump",    tag: "Deal-Making · Branding",           price: "₦2,500/mo · 7.8k users",  featured: false },
];

export function CelebrityHero() {
      ...
      >
        {CELEB_CHIPS.map((chip) => (
          <button
            ...
            onMouseLeave={(e) => {
              const btn = e.currentTarget as HTMLButtonElement;
              btn.style.borderColor = chip.featured ? "rgba(245,166,35,.4)" : "rgba(255,255,255,.1)";
              btn.style.background = chip.featured ? "rgba(245,166,35,.1)" : "rgba(255,255,255,.05)";
              btn.style.transform = "";
            }}
          >
            {/* Avatar */}
            <div
              className="w-[38px] h-[38px] rounded-[10px] flex items-center justify-center flex-shrink-0 text-[15px]"
              style={{
                background: chip.avBg,
            ...
            <div>
              ...
              <div className="text-[10px] font-semibold mt-[2px] whitespace-nowrap" style={{ color: "var(--gold)" }}>{chip.price}</div>
            </div>
          </button>
        ))}
      </div>
